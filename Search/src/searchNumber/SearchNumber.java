...
public class SearchNumber {
	...
	public static void main(String[] args) {
		...
		found += searchNumber.findNumber(736022, randomNumArray);
		found += searchNumber.findNumber(123456, randomNumArray);
		
		searchNumber.print(found);
	}
	void pause(){
		System.out.println("Storing random numbers from "
						 + "1 to 1000000 in array of 500000");
		try {
